...
export default function AirportCreatePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok || !json.success) {
        ...
        else setError(json.message || "Failed to create airport.");
        return;
      }
      router.push("/admin/airports");
    } catch (e: any) {
      setError(e?.message || "Failed to create airport.");
    } finally {
      setSubmitting(false);
    }
  }
  ...
  return (
    <div style={styles.bg}>
      <div style={styles.shell}>
        <h1 style={styles.title}>🛫 Add New Airport</h1>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            <div style={styles.actionBar}>
              <button type="submit" style={styles.submitBtn} disabled={submitting}>
                {submitting ? "Creating..." : "Create Airport"}
              </button>
              <button
                type="button"
